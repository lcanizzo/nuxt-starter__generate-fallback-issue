...
!(function() {
  ...
  var i = (e.navigator || {}).userAgent,
    ...
    M = ['xs', 'sm', 'lg', 'fw', 'ul', 'li', 'border', 'pull-left', 'pull-right', 'spin', 'pulse', 'rotate-90', 'rotate-180', 'rotate-270', 'flip-horizontal', 'flip-vertical', 'stack', 'stack-1x', 'stack-2x', 'inverse', 'layers', 'layers-text', 'layers-counter']
      .concat(
        x.map(function(t) {
          return t + 'x';
        })
  ...
  var R = E({ familyPrefix: 'fa', replacementClass: g, autoReplaceSvg: !0, autoAddCss: !0, autoA11y: !0, searchPseudoElements: !1, observeMutations: !0, keepOriginalSource: !0, measurePerformance: !1, showMissingIcons: !0 }, j);
  ...
  function Z(t) {
    ...
    return {
      ...
      inner: { transform: 'translate(' + 32 * e.x + ', ' + 32 * e.y + ') ' + ' ' + ('scale(' + (e.size / 16) * (e.flipX ? -1 : 1) + ', ' + (e.size / 16) * (e.flipY ? -1 : 1) + ') ') + ' ' + ('rotate(' + e.rotate + ' 0 0)') },
  ...
  var $ = { x: 0, y: 0, width: '100%', height: '100%' },
      ...
      var e = t.children,
        ...
        p = {
          ...
          children: [
            ...
            { tag: 'mask', attributes: E({}, $, { id: g, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }), children: [u, d] }
          ]
        };
      return e.push(p, { tag: 'rect', attributes: E({ fill: 'currentColor', 'clip-path': 'url(#' + h + ')', mask: 'url(#' + g + ')' }, $) }), { children: e, attributes: r };
    },
    et = function(t) {
      var e = t.children,
        r = t.attributes,
      ...
      if ((0 < i.length && (r.style = i), Q(n))) {
        ...
        e.push({ tag: 'g', attributes: E({}, o.outer), children: [{ tag: 'g', attributes: E({}, o.inner), children: [{ tag: a.icon.tag, children: a.icon.children, attributes: E({}, a.icon.attributes, o.path) }] }] });
      } else e.push(a.icon);
    ...
    at = function(t) {
      ...
      return [{ tag: 'svg', attributes: { style: 'display: none;' }, children: [{ tag: 'symbol', attributes: E({}, n, { id: o }), children: a }] }];
    };
  function nt(t) {
    var e = t.icons,
      r = e.main,
    ...
    u && (v.attributes[A] = ''), l && v.children.push({ tag: 'title', attributes: { id: v.attributes['aria-labelledby'] || 'title-' + q() }, children: [l] });
  ...
  function it(t) {
    ...
    Q(n) &&
      ((y.transform =
        ...
        (p = c.startCentered),
        (b = ''),
        (b += (v = void 0 !== p && p) && k ? 'translate(' + (u.x / B - d / 2) + 'em, ' + (u.y / B - h / 2) + 'em) ' : v ? 'translate(calc(-50% + ' + u.x / B + 'em), calc(-50% + ' + u.y / B + 'em)) ' : 'translate(' + u.x / B + 'em, ' + u.y / B + 'em) '),
    ...
    var x = [];
    return x.push({ tag: 'span', attributes: f, children: [e] }), i && x.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [i] }), x;
  }
  var ot = function() {},
      ...
      (Lt = new s(function(t) {
        St ||
          U(t).forEach(function(t) {
            if (
              ('childList' === t.type && 0 < t.addedNodes.length && !Nt(t.addedNodes[0]) && (T.searchPseudoElements && o(t.target), n(t.target)),
  ...
  var Bt = { fill: 'currentColor' },
    ...
    qt = {
      ...
      children: [
        ...
        { tag: 'path', attributes: E({}, Bt, { opacity: '0', d: 'M232.5,134.5l7,168c0.3,6.4,5.6,11.5,12,11.5h9c6.4,0,11.7-5.1,12-11.5l7-168c0.3-6.8-5.2-12.5-12-12.5h-23 C237.7,122,232.2,127.7,232.5,134.5z' }), children: [{ tag: 'animate', attributes: E({}, Xt, { values: '0;0;1;1;0;0;' }) }] }
      ]
    },
    Ut = I.styles,
    Vt = 'fa-layers-text',
  ...
  function Qt(t, e) {
    ...
    if (t && e && Ut[e] && Ut[e][t]) {
      var a = Ut[e][t];
      r = { found: !0, width: a[0], height: a[1], icon: { tag: 'path', attributes: { fill: 'currentColor', d: a.slice(4)[0] } } };
  ...
  function Zt(t) {
    var e,
      ...
      b,
      y,
      w = ((r = jt((e = t))), (a = r.iconName), (n = r.prefix), (i = r.rest), (o = Ot(e)), (s = Tt(e)), (l = Ht(e)), (f = It(e)), (c = Ft(e)), { iconName: a, title: e.getAttribute('title'), prefix: n, transform: s, symbol: l, mask: c, extra: { classes: i, styles: o, attributes: f } });
    return ~w.extra.classes.indexOf(Vt)
      ? (function(t, e) {
          ...
          return T.autoA11y && !r && (n.attributes['aria-hidden'] = 'true'), [t, it({ content: t.innerHTML, width: i, height: o, transform: a, title: r, extra: n, watchable: !0 })];
        })(t, w)
      : ((u = t),
        (d = (m = w).iconName),
        (g = m.title),
        ...
        (b = m.mask),
        (y = m.extra),
        [u, nt({ icons: { main: Qt(d, h), mask: Qt(b.iconName, b.prefix) }, prefix: h, iconName: d, transform: p, symbol: v, mask: b, title: g, extra: y, watchable: !0 })]);
  }
  function $t(t) {
    if (c) {
              ...
              [':before', ':after'].forEach(function(e) {
                ...
                if (t && !a) u.removeChild(t);
                  ...
                  if (!t || t.getAttribute(p) !== o || t.getAttribute(v) !== s) {
                    ...
                    var l = _t.extra;
                    l.attributes[h] = e;
                    var f = nt(E({}, _t, { icons: { main: Qt(s, o), mask: wt() }, prefix: o, iconName: s, extra: l, watchable: !0 })),
    ...
    ce = {
      ...
      watch: function() {
        ...
        !1 === T.autoReplaceSvg && (T.autoReplaceSvg = !0),
          ...
          Y(function() {
            de({ autoReplaceSvgRoot: e }), Et({ treeCallback: te, nodeCallback: ee, pseudoElementsCallback: $t, observeMutationsRoot: r });
          });
      }
    },
    ue =
      ((se = function(t) {
        ...
        if (t) {
          ...
          return ie(E({ type: 'icon' }, t), function() {
            return (
              ne(),
              T.autoA11y && (f ? (d['aria-labelledby'] = T.replacementClass + '-title-' + q()) : (d['aria-hidden'] = 'true')),
              nt({ icons: { main: ae(b), mask: s ? ae(s.icon) : { found: !1, width: null, height: null, icon: {} } }, prefix: p, iconName: v, transform: E({}, D, a), symbol: i, title: f, extra: { attributes: d, styles: h, classes: u } })
            );
          });
        }
      }),
    ...
    me = {
      ...
      text: function(t) {
        ...
        return ie({ type: 'text', content: t }, function() {
          return ne(), it({ content: t, transform: E({}, D, a), title: i, extra: { attributes: f, styles: u, classes: [T.familyPrefix + '-layers-text'].concat(P(s)) } });
        });
      },
      counter: function(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        return ie({ type: 'counter', content: t }, function() {
          return (
            ...
            (function(t) {
              ...
              var o = [];
              return o.push({ tag: 'span', attributes: n, children: [e] }), r && o.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [r] }), o;
            })({ content: t.toString(), title: a, extra: { attributes: s, styles: f, classes: [T.familyPrefix + '-layers-counter'].concat(P(i)) } })
          );
        });
      },
      layer: function(t) {
